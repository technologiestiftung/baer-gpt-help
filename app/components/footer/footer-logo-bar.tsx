...
export const FooterLogoBar = () => (
	<div className="w-full flex flex-col justify-center items-center lg:items-start lg:flex-row pb-6 lg:py-6 gap-12 text-center lg:text-start text-schwarz-80">
