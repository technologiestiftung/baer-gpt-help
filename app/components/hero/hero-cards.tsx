...
export function HeroCards() {
	return (
		<div className="w-full my-[60px] md:mb-[80px] md:mt-[52px] lg:my-[100px] flex flex-col md:flex-row gap-5 md:gap-4 lg:gap-[46px] px-5 lg:max-w-[1411px]">
			...
			<Link
				to={content["hero.card.allTutorials.link"]}
				className="flex-1 min-w-0 bg-hellblau-100 hover:bg-hellblau-60 text-dunkelblau-200 p-3.5 lg:py-[22px] lg:px-[26px] rounded-[3px] min-h-[230px] md:h-[270px] lg:h-[305px] flex flex-col justify-end"
			>
				<div className="flex flex-col gap-1 lg:gap-3">
					<h3 className="text-xl leading-7 lg:text-3xl lg:leading-9 font-semibold">
