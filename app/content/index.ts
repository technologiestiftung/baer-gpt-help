export const content = {
	...
	"faq.section1.q2": "Wie beginne ich mit der Nutzung von BärGPT?",
	"faq.section1.a2.p1":
		"Nach der Anmeldung können Sie direkt loslegen. So starten Sie:",
	"faq.section1.a2.li1":
		"<strong>Datei hochladen</strong> – Klicken Sie auf „Datei hochladen“ oder ziehen Sie Ihre Datei per Drag & Drop ins Upload-Feld.",
	"faq.section1.a2.li2":
		"<strong>Frage stellen</strong> – Geben Sie Ihre erste Frage im Chat ein, z.B. „Was steht im Abschnitt zur Budgetplanung?“",
	"faq.section1.a2.p2":
	...
	"faq.section7.a4.p3": "<strong>Hinweis:</strong> Mehr Tipps & Tricks im Umgang mit KI finden Sie hier:",
	...
	"faq.section7.a7.li1": "<strong>Unvollständige oder uneinheitliche Quellen:</strong> Wenn sich Informationen in den Trainingsdaten widersprechen, kann die KI nicht sicher entscheiden, welche stimmt.",
	"faq.section7.a7.li2": "<strong>Veraltetes Wissen:</strong> Das Sprachmodell selbst ist zu einem bestimmten Zeitpunkt trainiert worden und kennt keine aktuellen Entwicklungen.",
	"faq.section7.a7.li3": "<strong>Mehrdeutige Anfragen:</strong> Wenn eine Frage unklar formuliert ist, kann BärGPT sie missverstehen.",
	"faq.section7.a7.li4": "<strong>Fehlerhafte Kombinationen:</strong> Beim Zusammenfassen mehrerer Quellen können Details verloren gehen oder falsch verknüpft werden.",
	...
	"faq.section7.a8.li1": "<strong>Quellen prüfen:</strong> Wenn eine Antwort Quellen enthält, öffnen Sie diese über die Schaltfläche „Quellen“ am Ende der Antwort. So sehen Sie den genauen Ursprung.",
	"faq.section7.a8.li2": "<strong>Fachlich abgleichen:</strong> Bei rechtlichen, organisatorischen oder aktuellen Themen immer mit offiziellen Dokumenten oder Kolleg:innen aus dem Fachbereich gegenprüfen.",
	"faq.section7.a8.li3": "<strong>Ergebnis hinterfragen:</strong> Wenn etwas unlogisch oder zu allgemein klingt, einfach nachfragen oder um eine genauere Begründung bitten.",
